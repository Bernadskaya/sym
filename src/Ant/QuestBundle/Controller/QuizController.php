...
use Ant\QuestBundle\Entity\Quiz;
use Ant\QuestBundle\Form\QuizType;
...
class QuizController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AntQuestBundle:Quiz')->findAll();

        return $this->render('AntQuestBundle:Quiz:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('AntQuestBundle:Quiz:new.html.twig', array(
            'entity' => $entity,
    ...
    public function  askAction(Request $request, $idQuest) {
        $em = $this->getDoctrine()->getManager();
        $quest = $em->getRepository('AntQuestBundle:Quest')->finById($idQuest);
        $answers = $em->getRepository('AntQuestBundle:Answers')->findByQuest($idQuest);

        $form = $this->createForm(new QuizType(), $answers, array(
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AntQuestBundle:Quiz')->find($id);
        ...
        return $this->render('AntQuestBundle:Quiz:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AntQuestBundle:Quiz:edit.html.twig', array(
            'entity'      => $entity,
